...
//    println(LinuxUtil.pathType("/root/index.html", "192.168.1.240", "root", "111111"))
    //创建文件夹
//    LinuxUtil.scpToOtherLinux("/root/test", "192.168.1.241", "192.168.1.240", "root", "111111")
//    LinuxUtil.scpToOtherLinux("/root/test/mkdirs/my.txt", "192.168.1.241", "192.168.1.240", "root", "111111")
    //ls
//    LinuxUtil.ls("/root", "192.168.1.240", "root", "111111").foreach(println)
